<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Create a new user account with role assignment</p>
        </div>
    </x-slot>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select name="role" id="role"
                        ...
                        <option value="board_member" {{ old('role') == 'board_member' ? 'selected' : '' }}>Board Member - Strategic & Financial Oversight</option>
